...
\section{Possible Approaches}
  ...
  \frame
  {
    ...
    \cmt{ There are 3 possible approaches to achieve the goal;
      ...
      A more general version of this question would be to develop different
        levels of annotations that yield different amounts of higher-level
        information in the LLVM IR, as discussed in Section 1.2. 
  ...
  \frame
  {
    ...
    \begin{itemize}
      \item Selected ``mcsema'' among the existing \MC\ $\rightarrow$ \LIR\ solutions.  
        \begin{itemize}
          \item Comapred the existing tools (mcsema, Dagger, BAP, Fracture, QEMU)
...
\section*{Questions ?}
  ...
  \frame
  {
    ...
    \begin{itemize}
      \item Today: ??
      \item Variable, Type, Function Parameter Recovery seems to be beneficial.
    \end{itemize}
  }
