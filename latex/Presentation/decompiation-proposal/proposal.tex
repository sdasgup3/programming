...
\section{Possible Approaches}
  ...
  \frame
  {
    ...
    %\underline{Research Goal} \vspace{1mm} \\
    \textbf{Research Goal}:   Obtain ``richer'' LLVM IR than native machine code.
...
\section{Present Status}
  ...
  \frame
  {
    \frametitle{\subsecname}
    \begin{itemize}
      \item Selected ``mcsema'' among the existing \MC\ $\rightarrow$ \LIR\ solution.  
        \begin{itemize}
          \item Analysing the quality of IR recovery.
  ...
  \frame
  {
    ...
    \begin{itemize}
      \item Processor state: Modelled as struct of {\tt ints}
      \item Processor memory: Modelled as flat array of bytes
    \end{itemize}
    \begin{figure}[h]
      \centering
        \scalebox{0.45}{
  ...
  \subsection{Variable, Type \& Function Parameter Recovery}
  \frame
  {
    \frametitle{\subsecname}
    \begin{itemize}
