...
\begin{body}
	...
	\begin{itemize} \itemsep -0pt
		\item  Working with \href{http://llvm.org/}{ LLVM Group} led by Prof. \href{http://llvm.cs.uiuc.edu/~vadve/Home.html}{Vikram S. Adve}
		\item  Current Research: Finding pointer analysis bugs using a mix of symbolic execution strategies (like in KLEE and DART). 
	\end{itemize}
