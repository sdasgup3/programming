...
\begin{tabular}{l}
\qquad\qquad\qquad\qquad\qquad\qquad\qquad {{\texttt{email}: sdasgup3 [at] illinois [dot] edu}} \\
...
\begin{body}
	...
	\begin{itemize} \itemsep -0pt
		\item  Working with \href{http://llvm.org/}{ LLVM Group} led by Prof. \href{http://web.engr.illinois.edu/~vadve/Home.html}{Vikram S. Adve}
                ...
                dynamic symbolic execution. Currently we are focusing on bugs in ``must alias analysis''.
                \end{itemize}
