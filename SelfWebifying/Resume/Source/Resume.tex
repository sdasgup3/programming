...
\begin{tabular}{l}
\qquad\qquad\qquad\qquad\qquad\qquad\qquad {\normalsize{\texttt{email}: sdasgup3 [at] cs [dot] illinois [dot] edu}} \\
\qquad\qquad\qquad\qquad\qquad\qquad\qquad {\normalsize{\texttt{url}: \url{http://web.engr.illinois.edu/~sdasgup3}}} \\
\qquad\qquad\qquad\qquad\qquad\qquad\qquad {\normalsize{\texttt{phone}: (+1) 2174172344}} \\
\end{tabular}  
\end{tabular} \\
&\\
\end{tabular} 
