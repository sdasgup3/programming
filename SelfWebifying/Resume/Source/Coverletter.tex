...
\begin{center}
\large\bf Sandeep Dasgupta \\ % Your name
%\vspace{20pt} \hrule height 1pt % If you would like a horizontal line separating the name from the address, uncomment the line to the left of this text
Apt 16, 604 East White Street \\ Champaign, Illinois 61820 \\ (217) 417-2344  \\ sdasgup3@illinois.edu% Your address and phone number
\end{center} 
\vfill

\signature{Sandeep Dasgupta} % Your name for the signature at the bottom
...
%State the reason for the letter, name the position or type of work you are applying for and identify the source from which you learned of the opening (i.e. career development center, newspaper, employment service, personal contact).
